...
/**
 * This is a class created for accurate clasification.It
 * has no practical meaning.It is basically the main body 
 * of the XMLManager class;
 * @author magiclu550
 * @since EQuery 020
 * @since JDK 1.8
 * @see XMLManager
 */
public class InitXMLManager extends XMLManager{
	private static final long serialVersionUID = -2736063996145963051L;

	public InitXMLManager() {
		super();
	}
